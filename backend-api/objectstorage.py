...
COS_API_KEY_ID = "ShThhgMAzLxFhkba-7bAi3ZychcFBHVd0mGsZQbZBnTZ" # example: xxxd12V2QHXbjaM99G9tWyYDgF_0gYdlQ8aWALIQxXx4
COS_AUTH_ENDPOINT = "https://iam.cloud.ibm.com/identity/token"
COS_SERVICE_CRN = "crn:v1:bluemix:public:iam-identity::a/bd65df9a28b14db2a2e5baf9f5b437f8::serviceid:ServiceId-3dd2ea49-0bd8-4d3a-b0c6-aa24e275b843" # example: crn:v1:bluemix:public:cloud-object-storage:global:a/xx999cd94a0dda86fd8eff3191349999:9999b05b-x999-4917-xxxx-9d5b326a1111::
...
# Upload image
def upload_image_bucket(bucket_name, item_name, image):
    print("Creating new item: {0} in bucket: {1}".format(item_name, bucket_name))
    try:
        cos_cli = get_cos_client()
        cos_cli.put_object(
        ...
        log_error("Unable to upload image: {0}".format(e))
